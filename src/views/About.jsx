        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left">
            ...
            <p className="about-text-reveal font-sans text-base text-gray-700 mb-8 leading-relaxed">
              {t("about.description", "Perenk Petshop, basit bir fikirden doğdu: Her evcil hayvan, en iyi bakımı ve sevgiyi hak eder. İstanbul'un kalbinde, hayvansever bir ekip olarak, dostlarınız için en kaliteli, sağlıklı ve eğlenceli ürünleri bir araya getirmek için yola çıktık.")}
            </p>
